...
<script type="text/javascript">
	...
	window.actionEvents = {
	    ...
	    'click .delete': function (e, value, row, index) {
	    	...
	    	ajax_callText( "userManager/delete.action" ,value,function(){
	...
	// 新建 
	function user_add() {
		ad_open( "prototype/bootstrap_table/user_manageUser.jsp", "新建用户", "770", "250" ) ;
	}
...
<body>
	<s:form cssClass="container-fluid" action="jumpToUserList" namespace="/userManager" method="post">
		...
		<span style="color:red">当前位置:</span><span> >> </span><a href="prototype/bootstrap_table/user_roleList.jsp">角色列表</a><span> >>管理用户</span>
		<table id="btTable" data-toggle="table" data-url="userManager/userList.action?userAnduserType.typeId=<s:property value="userAnduserType.typeId" />" data-sort-name="name" data-sort-order="asc" data-toolbar="#toolbar" >
			<thead>
				<tr>
					<th data-checkbox="true"></th>
					<th data-formatter="bt_order">#</th>
					<th data-field="username" data-sortable="true">用户名</th>
					<th data-field="typeId" data-sortable="true">角色类型</th>
